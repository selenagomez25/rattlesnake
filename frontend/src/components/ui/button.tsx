  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-transparent shadow-sm hover:shadow-md hover:bg-accent/10 hover:text-accent-foreground hover:-translate-y-0.5",
        secondary:
        ...
        minimal: "bg-background/50 backdrop-blur-sm border border-border/40 hover:border-primary/50 text-foreground shadow-sm hover:shadow-md hover:-translate-y-0.5",
      },
      size: {
